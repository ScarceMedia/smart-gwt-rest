 ...
 * @author jeremy
 */
public class PersistModuleGeneratorTest extends AbstractGeneratorTest<PersistModuleGenerator> {

  @Override
  protected PersistModuleGenerator createGenerator(Settings settings, Definition definition, PackageDefinition packageDefinition, Model model) {
    return new PersistModuleGenerator(settings, definition, packageDefinition, model);
  }
